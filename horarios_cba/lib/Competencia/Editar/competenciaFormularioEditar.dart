...
class CompetenciaFormularioEditar extends StatefulWidget {
  const CompetenciaFormularioEditar({super.key});

  @override
  State<CompetenciaFormularioEditar> createState() =>
      _CompetenciaFormularioEditarState();
}

class _CompetenciaFormularioEditarState
    extends State<CompetenciaFormularioEditar> {
