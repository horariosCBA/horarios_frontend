...
class CalendarioCoordinador extends StatefulWidget {
  const CalendarioCoordinador({super.key});

  @override
  State<CalendarioCoordinador> createState() => _CalendarioCoordinadorState();
}

class _CalendarioCoordinadorState extends State<CalendarioCoordinador> {
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            // Botón "Añadir Horario" visible solo en dispositivos no móviles
        ...
        // Botón "Añadir Horario" visible solo en dispositivos móviles
        if (Responsive.isMobile(context))
          Center(
            child: Container(
              width: 200,
