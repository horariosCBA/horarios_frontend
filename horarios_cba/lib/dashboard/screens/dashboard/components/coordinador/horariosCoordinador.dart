...
import 'package:horarios_cba/Dashboard/listas/horarios.dart';
import 'package:horarios_cba/Models/usuarioModel.dart';
import 'package:horarios_cba/PDF/CoordinadorPDF/pdfHorarioCoordinador.dart';
import 'package:horarios_cba/PDF/modalsPdf.dart';
import 'package:horarios_cba/constantsDesign.dart';
import 'package:syncfusion_flutter_datagrid/datagrid.dart';

class HorariosCoordinador extends StatefulWidget {
  final UsuarioModel usuarioAutenticado;
  const HorariosCoordinador({super.key, required this.usuarioAutenticado});

  @override
  State<HorariosCoordinador> createState() => _HorariosCoordinadorState();
}

class _HorariosCoordinadorState extends State<HorariosCoordinador> {
  late HorariosCoordinadorDataGridSource _dataGridSource;
  ...
  void initState() {
    ...
    _dataGridSource = HorariosCoordinadorDataGridSource(horarios: horarios);
  }
                ...
                buildButton('Imprimir Reporte', () {
                  if (registros.isEmpty) {
                    ...
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => PdfHorariosCoordinadorScreen(
...
class HorariosCoordinadorDataGridSource extends DataGridSource {
  HorariosCoordinadorDataGridSource({required List<Horarios> horarios}) {
    _horariosCoordinadorData = horarios.map<DataGridRow>((horarios) {
  ...
  List<DataGridRow> _horariosCoordinadorData = [];

  @override
  List<DataGridRow> get rows => _horariosCoordinadorData;
