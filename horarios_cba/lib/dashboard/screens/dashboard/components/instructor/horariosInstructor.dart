...
import 'package:horarios_cba/PDF/InstructorPDF/pdfHorariosInstructor.dart';
import 'package:horarios_cba/PDF/modalsPdf.dart';
import 'package:horarios_cba/constantsDesign.dart';
import 'package:syncfusion_flutter_datagrid/datagrid.dart';
import '../../../../listas/horarios.dart';

class HorariosInstructor extends StatefulWidget {
  final UsuarioModel usuarioAutenticado;
  const HorariosInstructor({super.key, required this.usuarioAutenticado});

  @override
  State<HorariosInstructor> createState() => _HorariosInstructorState();
}

class _HorariosInstructorState extends State<HorariosInstructor> {
  late HorariosInstructorDataGridSource _dataGridSource;
  ...
  void initState() {
    ...
    _dataGridSource = HorariosInstructorDataGridSource(horarios: horarios);
  }
                ...
                buildButton('Imprimir Reporte', () {
                  if (registros.isEmpty) {
                    ...
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => PdfHorariosInstructorScreen(
...
class HorariosInstructorDataGridSource extends DataGridSource {
  HorariosInstructorDataGridSource({required List<Horarios> horarios}) {
    _horariosInstructorData = horarios.map<DataGridRow>((horarios) {
  ...
  List<DataGridRow> _horariosInstructorData = [];

  @override
  List<DataGridRow> get rows => _horariosInstructorData;
