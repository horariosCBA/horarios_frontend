...
class CoordinadoresAdministrador extends StatefulWidget {
  const CoordinadoresAdministrador({super.key});
  ...
  CoordinadoresAdministradorDataGridSource(
    ...
    _coordinadoresAdministradorData =
      ...
      return DataGridRow(cells: [
        DataGridCell<String>(
            columnName: 'Nombre Completo', value: coordinador.nombresApellidos),
        DataGridCell<String>(
          ...
          child: Row(
            children: [
              SvgPicture.asset(
                ...
                width: 30,
                colorFilter:
                    const ColorFilter.mode(Color(0xFFB836ED), BlendMode.srcIn),
              ),
              Padding(
