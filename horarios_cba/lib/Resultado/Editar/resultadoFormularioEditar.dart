...
class ResultadoFormularioEditar extends StatefulWidget {
  const ResultadoFormularioEditar({super.key});

  @override
  State<ResultadoFormularioEditar> createState() =>
      _ResultadoFormularioEditarState();
}

class _ResultadoFormularioEditarState extends State<ResultadoFormularioEditar> {
