...
import 'package:horarios_cba/AsignacionAprendiz/tablaAprendiz.dart';
import 'package:horarios_cba/constantsDesign.dart';
import 'package:mask_text_input_formatter/mask_text_input_formatter.dart';

class AsignacionAprendizFormulario extends StatefulWidget {
  const AsignacionAprendizFormulario({super.key});

  @override
  State<AsignacionAprendizFormulario> createState() =>
      _AsignacionAprendizFormularioState();
}

class _AsignacionAprendizFormularioState
    extends State<AsignacionAprendizFormulario> {
  TextEditingController _fichaController = TextEditingController();

  List<FichasAprendiz> fichasFiltradas = [];

  @override
  void initState() {
    super.initState();
    // Inicializa la lista filtrada con todas las fichas al principio.
    fichasFiltradas = fichasAprendiz;
  }
        ...
        body: Container(
            decoration: const BoxDecoration(
                image: DecorationImage(
                    image: AssetImage('assets/img/fondoFormularioAprendices.webp'),
                    fit: BoxFit.cover)),
            child: Stack(
              children: [
