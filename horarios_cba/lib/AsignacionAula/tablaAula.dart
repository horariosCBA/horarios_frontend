...
class TablaAula extends StatefulWidget {
  const TablaAula({
    super.key,
  });

  @override
  State<TablaAula> createState() => _TablaAulaState();
}

class _TablaAulaState extends State<TablaAula> {
  late TablaAulaDataGridSource _dataGridSource;

  List<ProgramaAula> programas = [];
  ...
  void initState() {
    ...
    programas = listaProgramasAulas;

    _dataGridSource =
        TablaAulaDataGridSource(programas: programas, context: context);
  }
...
class TablaAulaDataGridSource extends DataGridSource {
  TablaAulaDataGridSource(
      {required List<ProgramaAula> programas, required BuildContext context}) {
    _tablaAulaData = programas.map<DataGridRow>((programa) {
  ...
  List<DataGridRow> _tablaAulaData = [];

  @override
  List<DataGridRow> get rows => _tablaAulaData;
