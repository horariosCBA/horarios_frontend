...
import 'package:horarios_cba/Planeacion/Editar/planeacionPantallasEditar.dart';
import 'package:horarios_cba/constantsDesign.dart';

class PlaneacionFormularioEditar extends StatefulWidget {
  const PlaneacionFormularioEditar({super.key});

  @override
  State<PlaneacionFormularioEditar> createState() =>
      _PlaneacionFormularioEditarState();
}

class _PlaneacionFormularioEditarState
    extends State<PlaneacionFormularioEditar> {
  PageController? controller;
  int currentIndex = 0;

  List<PantallasPlaneacion> listaPantallas = <PantallasPlaneacion>[];
              ...
              body: Container(
                  decoration: const BoxDecoration(
                      image: DecorationImage(
                          image: AssetImage(
                              'assets/img/fondoFormularioPlaneacion.webp'),
                          fit: BoxFit.cover)),
                  child: Stack(
                    children: [
...
// Método para definir las pantallas del sitio
  void _pantallasPlaneacion() {
    var lista = <PantallasPlaneacion>[
      // Primera pantalla con formulario
      PantallasPlaneacion(
          pantalla: Form(
        key: llave1,
        child: PantallaUnoPlaneacion(
...
class PantallasPlaneacion {
  Widget pantalla;

  PantallasPlaneacion({required this.pantalla});
}
