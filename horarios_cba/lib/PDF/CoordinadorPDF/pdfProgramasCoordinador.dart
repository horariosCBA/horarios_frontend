...
class PdfProgramasCoordinadorScreen extends StatefulWidget {
  const PdfProgramasCoordinadorScreen({
    super.key,
  ...
  @override
  State<PdfProgramasCoordinadorScreen> createState() =>
      _PdfProgramasCoordinadorScreenState(
          usuario: usuario, registros: registros);
}

class _PdfProgramasCoordinadorScreenState
    extends State<PdfProgramasCoordinadorScreen> {
  final UsuarioModel usuario;
