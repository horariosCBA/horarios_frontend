...
class PdfAsigAulasCoordinadorScreen extends StatefulWidget {
  const PdfAsigAulasCoordinadorScreen({
    super.key,
  ...
  @override
  State<PdfAsigAulasCoordinadorScreen> createState() =>
      _PdfAsigAulasCoordinadorScreenState(
          usuario: usuario, registros: registros);
}

class _PdfAsigAulasCoordinadorScreenState
    extends State<PdfAsigAulasCoordinadorScreen> {
  final UsuarioModel usuario;
