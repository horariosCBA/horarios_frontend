...
class PdfHorariosCoordinadorScreen extends StatefulWidget {
  const PdfHorariosCoordinadorScreen({
    super.key,
  ...
  @override
  State<PdfHorariosCoordinadorScreen> createState() =>
      _PdfHorariosCoordinadorScreenState(
          usuario: usuario, registros: registros);
}

class _PdfHorariosCoordinadorScreenState
    extends State<PdfHorariosCoordinadorScreen> {
  final UsuarioModel usuario;
