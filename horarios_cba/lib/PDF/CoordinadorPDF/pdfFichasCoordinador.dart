...
class PdfFichasCoordinadorScreen extends StatefulWidget {
  const PdfFichasCoordinadorScreen({
    super.key,
  ...
  @override
  State<PdfFichasCoordinadorScreen> createState() =>
      _PdfFichasCoordinadorScreenState(usuario: usuario, registros: registros);
}

class _PdfFichasCoordinadorScreenState
    extends State<PdfFichasCoordinadorScreen> {
  final UsuarioModel usuario;

  final List<DataGridRow> registros;

  _PdfFichasCoordinadorScreenState({
    required this.usuario,
    required this.registros,
  });
  ...
  Future<Uint8List> generatePdf(final PdfPageFormat format) async {
    final doc = pw.Document(
      title: 'CBA Mosquera reporte de fichas',
    );
