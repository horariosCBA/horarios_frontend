...
class PdfTrimestresCoordinadorScreen extends StatefulWidget {
  const PdfTrimestresCoordinadorScreen({
    super.key,
  ...
  @override
  State<PdfTrimestresCoordinadorScreen> createState() =>
      _PdfTrimestresCoordinadorScreenState(
          usuario: usuario, registros: registros);
}

class _PdfTrimestresCoordinadorScreenState
    extends State<PdfTrimestresCoordinadorScreen> {
  final UsuarioModel usuario;
