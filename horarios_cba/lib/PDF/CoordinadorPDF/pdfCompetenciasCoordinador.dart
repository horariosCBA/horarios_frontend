...
class PdfCompetenciasCoordinadorScreen extends StatefulWidget {
  const PdfCompetenciasCoordinadorScreen({
    super.key,
  ...
  @override
  State<PdfCompetenciasCoordinadorScreen> createState() =>
      _PdfCompetenciasCoordinadorScreenState(
          usuario: usuario, registros: registros);
}

class _PdfCompetenciasCoordinadorScreenState
    extends State<PdfCompetenciasCoordinadorScreen> {
  final UsuarioModel usuario;
