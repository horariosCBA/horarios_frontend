...
class PdfInstructoresCoordinadorScreen extends StatefulWidget {
  const PdfInstructoresCoordinadorScreen({
    super.key,
  ...
  @override
  State<PdfInstructoresCoordinadorScreen> createState() =>
      _PdfInstructoresCoordinadorScreenState(
          usuario: usuario, registros: registros);
}

class _PdfInstructoresCoordinadorScreenState
    extends State<PdfInstructoresCoordinadorScreen> {
  final UsuarioModel usuario;
