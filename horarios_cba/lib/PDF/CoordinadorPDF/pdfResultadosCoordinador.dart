...
class PdfResultadosCoordinadorScreen extends StatefulWidget {
  const PdfResultadosCoordinadorScreen({
    super.key,
  ...
  @override
  State<PdfResultadosCoordinadorScreen> createState() =>
      _PdfResultadosCoordinadorScreenState(
          usuario: usuario, registros: registros);
}

class _PdfResultadosCoordinadorScreenState
    extends State<PdfResultadosCoordinadorScreen> {
  final UsuarioModel usuario;
