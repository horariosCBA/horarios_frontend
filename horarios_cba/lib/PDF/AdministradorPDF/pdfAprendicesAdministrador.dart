...
class PdfAprendicesAdministradorScreen extends StatefulWidget {
  const PdfAprendicesAdministradorScreen({
    super.key,
  ...
  @override
  State<PdfAprendicesAdministradorScreen> createState() =>
      _PdfAprendicesAdministradorScreenState(
          usuario: usuario, registros: registros);
}

class _PdfAprendicesAdministradorScreenState
    extends State<PdfAprendicesAdministradorScreen> {
  final UsuarioModel usuario;
