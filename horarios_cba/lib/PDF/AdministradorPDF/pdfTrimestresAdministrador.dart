...
class PdfTrimestresAdministradorScreen extends StatefulWidget {
  const PdfTrimestresAdministradorScreen({
    super.key,
  ...
  @override
  State<PdfTrimestresAdministradorScreen> createState() =>
      _PdfTrimestresAdministradorScreenState(
          usuario: usuario, registros: registros);
}

class _PdfTrimestresAdministradorScreenState
    extends State<PdfTrimestresAdministradorScreen> {
  final UsuarioModel usuario;
  ...
  Future<Uint8List> generatePdf(final PdfPageFormat format) async {
    final doc = pw.Document(
      title: 'CBA Mosquera reporte de trimestres',
    );
