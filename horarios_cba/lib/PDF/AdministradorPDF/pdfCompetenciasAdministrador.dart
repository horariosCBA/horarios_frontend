...
class PdfCompetenciasAdministradorScreen extends StatefulWidget {
  const PdfCompetenciasAdministradorScreen({
    super.key,
  ...
  @override
  State<PdfCompetenciasAdministradorScreen> createState() =>
      _PdfCompetenciasAdministradorScreenState(
          usuario: usuario, registros: registros);
}

class _PdfCompetenciasAdministradorScreenState
    extends State<PdfCompetenciasAdministradorScreen> {
  final UsuarioModel usuario;
  ...
  Future<Uint8List> generatePdf(final PdfPageFormat format) async {
    final doc = pw.Document(
      title: 'CBA Mosquera reporte de competencias',
    );
