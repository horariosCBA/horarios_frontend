...
class PdfInstructoresAdministradorScreen extends StatefulWidget {
  const PdfInstructoresAdministradorScreen({
    super.key,
  ...
  @override
  State<PdfInstructoresAdministradorScreen> createState() =>
      _PdfInstructoresAdministradorScreenState(
          usuario: usuario, registros: registros);
}

class _PdfInstructoresAdministradorScreenState
    extends State<PdfInstructoresAdministradorScreen> {
  final UsuarioModel usuario;
  ...
  Future<Uint8List> generatePdf(final PdfPageFormat format) async {
    final doc = pw.Document(
      title: 'CBA Mosquera reporte de instructores',
    );
