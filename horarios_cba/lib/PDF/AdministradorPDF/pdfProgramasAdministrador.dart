...
class PdfProgramasAdministradorScreen extends StatefulWidget {
  const PdfProgramasAdministradorScreen({
    super.key,
  ...
  @override
  State<PdfProgramasAdministradorScreen> createState() =>
      _PdfProgramasAdministradorScreenState(
          usuario: usuario, registros: registros);
}

class _PdfProgramasAdministradorScreenState
    extends State<PdfProgramasAdministradorScreen> {
  final UsuarioModel usuario;
  ...
  Future<Uint8List> generatePdf(final PdfPageFormat format) async {
    final doc = pw.Document(
      title: 'CBA Mosquera reporte de programas',
    );
