...
class PdfFichasAdministradorScreen extends StatefulWidget {
  const PdfFichasAdministradorScreen({
    super.key,
  ...
  @override
  State<PdfFichasAdministradorScreen> createState() =>
      _PdfFichasAdministradorScreenState(
          usuario: usuario, registros: registros);
}

class _PdfFichasAdministradorScreenState
    extends State<PdfFichasAdministradorScreen> {
  final UsuarioModel usuario;
