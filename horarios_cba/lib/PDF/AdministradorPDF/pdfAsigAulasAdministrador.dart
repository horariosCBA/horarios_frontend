...
class PdfAsigAulasAdministradorScreen extends StatefulWidget {
  const PdfAsigAulasAdministradorScreen({
    super.key,
  ...
  @override
  State<PdfAsigAulasAdministradorScreen> createState() =>
      _PdfAsigAulasAdministradorScreenState(
          usuario: usuario, registros: registros);
}

class _PdfAsigAulasAdministradorScreenState
    extends State<PdfAsigAulasAdministradorScreen> {
  final UsuarioModel usuario;
  ...
  Future<Uint8List> generatePdf(final PdfPageFormat format) async {
    final doc = pw.Document(
      title: 'CBA Mosquera reporte de asignación de aulas',
    );
    ...
    doc.addPage(
      pw.MultiPage(
        ...
        build: (final context) => [
          ...
          pw.Center(
            child: pw.Text(
              "Reporte de asignación de aulas",
