...
class PdfCoordinadoresAdministradorScreen extends StatefulWidget {
  const PdfCoordinadoresAdministradorScreen({
    super.key,
  ...
  @override
  State<PdfCoordinadoresAdministradorScreen> createState() =>
      _PdfCoordinadoresAdministradorScreenState(
          usuario: usuario, registros: registros);
}

class _PdfCoordinadoresAdministradorScreenState
    extends State<PdfCoordinadoresAdministradorScreen> {
  final UsuarioModel usuario;
  ...
  Future<Uint8List> generatePdf(final PdfPageFormat format) async {
    final doc = pw.Document(
      title: 'CBA Mosquera reporte de coordinadores',
    );
