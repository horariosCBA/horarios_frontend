...
class PdfHorariosAprendizScreen extends StatefulWidget {
  const PdfHorariosAprendizScreen({
    super.key,
  ...
  @override
  State<PdfHorariosAprendizScreen> createState() =>
      _PdfHorariosAprendizScreenState(usuario: usuario, registros: registros);
}

class _PdfHorariosAprendizScreenState extends State<PdfHorariosAprendizScreen> {
  final UsuarioModel usuario;

  final List<DataGridRow> registros;

  _PdfHorariosAprendizScreenState({
    required this.usuario,
    required this.registros,
  });
