...
class PdfFichasAprendicesScreen extends StatefulWidget {
  const PdfFichasAprendicesScreen({
    super.key,
  ...
  @override
  State<PdfFichasAprendicesScreen> createState() =>
      _PdfFichasAprendicesScreenState(usuario: usuario, registros: registros);
}

class _PdfFichasAprendicesScreenState extends State<PdfFichasAprendicesScreen> {
  final UsuarioModel usuario;

  final List<DataGridRow> registros;

  _PdfFichasAprendicesScreenState({
    required this.usuario,
    required this.registros,
  });
