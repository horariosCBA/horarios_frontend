...
class PdfProgramacionesAprendicesScreen extends StatefulWidget {
  const PdfProgramacionesAprendicesScreen({
    super.key,
  ...
  @override
  State<PdfProgramacionesAprendicesScreen> createState() =>
      _PdfProgramacionesAprendicesScreenState(
          usuario: usuario, registros: registros);
}

class _PdfProgramacionesAprendicesScreenState
    extends State<PdfProgramacionesAprendicesScreen> {
  final UsuarioModel usuario;
