...
class PdfFichasInstructorScreen extends StatefulWidget {
  const PdfFichasInstructorScreen({
    super.key,
  ...
  @override
  State<PdfFichasInstructorScreen> createState() =>
      _PdfFichasInstructorScreenState(usuario: usuario, registros: registros);
}

class _PdfFichasInstructorScreenState extends State<PdfFichasInstructorScreen> {
  final UsuarioModel usuario;

  final List<DataGridRow> registros;

  _PdfFichasInstructorScreenState({
    required this.usuario,
    required this.registros,
  });
