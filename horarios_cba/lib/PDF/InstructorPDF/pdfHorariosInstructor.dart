...
class PdfHorariosInstructorScreen extends StatefulWidget {
  const PdfHorariosInstructorScreen({
    super.key,
  ...
  @override
  State<PdfHorariosInstructorScreen> createState() =>
      _PdfHorariosInstructorScreenState(usuario: usuario, registros: registros);
}

class _PdfHorariosInstructorScreenState
    extends State<PdfHorariosInstructorScreen> {
  final UsuarioModel usuario;

  final List<DataGridRow> registros;

  _PdfHorariosInstructorScreenState({
    required this.usuario,
    required this.registros,
  });
  ...
  Future<Uint8List> generatePdf(final PdfPageFormat format) async {
    final doc = pw.Document(
      title: 'CBA Mosquera reporte de horarios',
    );
