...
class PdfProgramacionesInstructorScreen extends StatefulWidget {
  const PdfProgramacionesInstructorScreen({
    super.key,
  ...
  @override
  State<PdfProgramacionesInstructorScreen> createState() =>
      _PdfProgramacionesInstructorScreenState(
          usuario: usuario, registros: registros);
}

class _PdfProgramacionesInstructorScreenState
    extends State<PdfProgramacionesInstructorScreen> {
  final UsuarioModel usuario;
