...
class TablaInstructor extends StatefulWidget {
  const TablaInstructor({
    super.key,
  });

  @override
  State<TablaInstructor> createState() => _TablaInstructorState();
}

class _TablaInstructorState extends State<TablaInstructor> {
  late TablaInstructorDataGridSource _dataGridSource;

  List<ProgramaInstructor> programas = [];
  ...
  void initState() {
    ...
    programas = listaProgramasInstructor;

    _dataGridSource =
        TablaInstructorDataGridSource(programas: programas, context: context);
  }
...
class TablaInstructorDataGridSource extends DataGridSource {
  TablaInstructorDataGridSource(
      {required List<ProgramaInstructor> programas,
      required BuildContext context}) {
    _tablaInstructorData = programas.map<DataGridRow>((programa) {
  ...
  List<DataGridRow> _tablaInstructorData = [];

  @override
  List<DataGridRow> get rows => _tablaInstructorData;
